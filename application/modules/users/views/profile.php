 	 ...
 	 <div class=" profile">
		...
		<div class="profile-bottom">
			...
			<div class="col-md-8 profile-text">
				...
				<table>
					...
					<tr>
						<td>User ID</td>
						<td> :</td>
						<td> <?php echo $profileDetail->contact; ?></td>
					</tr>
					<tr>
						<td>Email</td>
						<td> :</td>
			...
			<div class="col-md-4 profile-fo">
				<h4> R <?php echo number_format(get_user_offer_help_received( $profileDetail->user_id),2); ?></h4>
				<p>Help Given</p>
				<a href="<?php echo base_url('offers/user/create');?>" class="pro"><i class="fa fa-plus-circle"></i>Offer Help</a>
			</div>
			<div class="col-md-4 profile-fo">
				<h4>R <?php echo number_format(get_user_help_received($profileDetail->user_id),2);?></h4>
				<p>Help Received</p>
				<a href="<?php echo base_url('request/create');?>" class="pro1"><i class="fa fa-user"></i>Request Help</a>
			</div>
			<div class="col-md-4 profile-fo">
				<h4>R <?php echo number_format(get_user_balance($profileDetail->user_id),2)?></h4>
				<p>Balance</p>
